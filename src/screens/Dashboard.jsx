...
import { getSubmitDateSInput } from "@/modules/calculatefunctions";
const Dashboard = () => {
  ...
  return (
    <div className="my-3">
      ...
      <p>
        Logged At{" "}
        {getSubmitDateSInput(new Date(state.LOGGEDAT).toLocaleDateString())} at{" "}
        {new Date(state.LOGGEDAT).toLocaleString().split(",")[1]}
      </p>
